import { FaNewspaper, FaFolderOpen, FaMountainSun } from "react-icons/fa6";
import { FaPenNib, FaSlidersH, FaSun, FaUser, FaUsers } from "react-icons/fa";
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              ...
              >
                <FaNewspaper className="text-2xl text-orange-500 mb-1 m-auto" />
              ...
              >
                <FaUsers className="text-3xl text-orange-500 mb-1 m-auto" />
                <p className="text-2xl md:text-3xl font-bold gradient-text">
                  +10ألف
                </p>
              ...
              >
                <FaFolderOpen className="fa-solid fa-folder-open text-2xl text-orange-500 mb-1 m-auto" />
                <p className="text-2xl md:text-3xl font-bold gradient-text">
                  4
                </p>
              ...
              >
                <FaPenNib className="fa-solid fa-pen-nib text-2xl text-orange-500 mb-1 m-auto" />
                <p className="text-2xl md:text-3xl font-bold gradient-text">
                  6
                </p>
      ...
      <section className="py-24 bg-[#0a0a0a] relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {posts.posts.filter(post=>post.featured===true).map(ele=><article
      ...
      <section className="py-24 bg-[#111111] relative border-y border-[#262626]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-5xl md:text-6xl font-bold text-white">استكشف حسب الموضوع</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            >
              ...
              <div className="relative z-10">
                <div className="w-12 h-12 bg-orange-500/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-white/20 transition-colors duration-300 border border-orange-500/20 group-hover:border-transparent">
                  <FaSlidersH className="text-xl text-orange-500 group-hover:text-white transition-colors duration-300" />
                </div>
                <h3 className="font-bold text-lg text-white group-hover:text-white transition-colors duration-300 mb-1">
                  تقنيات
                </h3>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
            <div>
              ...
              <h2 className="text-5xl md:text-6xl font-bold text-white">أحدث المقالات</h2>
              <p className="section-subtitle max-w-lg">
